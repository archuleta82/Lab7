...
//        if( x3.equals(allTheBooks[2].getAuthor().getInfoString()) ) { tScore++; }
//        if( x4.equals(allTheBooks[0].getAuthor().getInfoString()) ) { tScore++; }
//        if( x5.equals(allTheBooks[1].getAuthor().getInfoString()) ) { tScore++; }
